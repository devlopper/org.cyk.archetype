...
public abstract class AbstractBusinessIT extends AbstractIntegrationTestJpaBased {
	...
	@Inject protected BusinessLayer ${systemIdentifier}BusinessLayer;
	@Inject protected BusinessTestHelper ${systemIdentifier}BusinessTestHelper;
	...
	protected void installApplication(Boolean fake){
    	${systemIdentifier}BusinessLayer.installApplication(fake);
    }
    ...
    public static Archive<?> createRootDeployment() {
        return  
                new ArchiveBuilder().create().getArchive().
                    ...
                    addPackages(Boolean.TRUE,"org.cyk.system.${systemIdentifier}") 
                ;
    } 
